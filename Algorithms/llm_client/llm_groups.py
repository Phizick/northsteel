...
async def llm_groups(message):
    ...
    data = {
        "messages": [
            {
                "role": "user",
                "content": f"найди компании участников российского рынка {message} и составь из "
                           f"них список из 3 компаний в виде массива groups[].ответ верни только массивом "
                           f"на русском языке без лишних комментариев"
