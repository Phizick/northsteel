...
async def llm_table_about(query):
    ...
    f"в отчет включи все данные какие посчитаешь нужными, лучше если это будут цифры. верни ответ в виде JSON "
                            f"обьекта. все поля-значения должны быть в одном обьекте. Следи за тем, что бы не было "
                            f"вложенных обьектов/массивов и формат данных сохранялся четко "
    f"")
    }
    ],
        "max_tokens": 4096
